...
.mid_mainpage_ver_todos_productos{
    margin-top: rem;
  font-weight: bold;
  width: 100%;
...
.mid_mainpage_ver_todos_productos:hover{
    color: {$color_texto};
     text-decoration: none;
}
.mid-ver-todos-button-container{
    margin-bottom: 2rem;
}
</style>
...
<body >
   ...
   <main class="mid_mainpage_main">
   <h2 class="ini_mainpage_colortexto-db">Ultimas novedades de {$shopFront[0]->nombre_simple}</h2>
   <div class="mid-ver-todos-button-container mt-2">
   <a href="{$shopName}/products" class="mid_mainpage_ver_todos_productos">Ver todos los productos</a>
      ...
      <div class="mid-ver-todos-button-container">
        <a href="{$shopName}/products" class="mid_mainpage_ver_todos_productos">Ver todos los productos</a>
