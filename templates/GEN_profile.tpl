...
<body>
   <div class="container">
      ...
      <div class="profile-vencimiento mt-4">
         ...
         {/if}
         <a href="payments/{$userinfo.usuario.id}">
            Ir a pagos 
      ...
      <div class="card p-4 mt-4">
         <ul class="nav nav-tabs  " id="myTab" role="tablist">
            ...
            <li class="nav-item mr-1" role="presentation">
               <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#Shop" type="button" role="tab" aria-controls="Shop" aria-selected="false">Mi tienda</button>
            </li>
            <li class="nav-item mr-1" role="presentation">
         ...
         <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show " id="seguridad" role="tabpanel" aria-labelledby="seguridad-tab">
               <div class="mt-2">
                  ...
                  <hr>
                  <div class="profile-control-info-b" id="old-pass-container">
                     <span>Contraseña actual</span>
                     <input type="password" id="old_pass" value="" autocomplete="new-password">
                  </div>
                  <div class="profile-control-info-b">
                     <span>Contraseña nueva</span>
                     <input type="password" id="new_pass" value="">
                  </div>
                  <div class="profile-control-info-b">
                     <span>Repetir contraseña nueva</span>
                     <input type="password" id="r_new_pass" value="">
                  </div>
                  <button 
                     onclick="changePassword()"
                     class="profile-personal-info-save-button"  id="change-password">
                  Cambiar contraseña
                  </button>
                  <script>
                  ...
                  <div class="d-flex">
                     <div class="profile-acount-fhalf">
                        ...
                        <div class="profile-control-info">
                           ...
                           <input type="text" id="nombreCuenta" value="{$userinfo.usuario.usuario}" onkeydown="return evitarEspacios(event)">
                        </div>
                        <script>
                           function evitarEspacios(event) {
                               // Si la tecla presionada es un espacio (código 32), evita que se escriba
                               if (event.key === ' ') {
                        ...
                        <button 
                           ...
                           class="profile-personal-info-save-button" id="save-info-profile-1">
                        Guardar
                        </button>
                     </div>
                     <script>
                     ...
                     <div class="profile-acount-shalf">
                              ...
                              <div class="modal-content">
                                 ...
                                 <div class="modal-body">
                                    <form>
                                       ...
                                       <!-- Input adicional (inicialmente oculto) -->
                                       <div class="mb-3" id="softwareInputWrapper" style="display: none;">
                                          <label for="softwareInput_cypher" class="form-label">Nombre del Software</label>
                                          <input type="text" class="form-control" id="softwareInput_cypher" placeholder="Ingrese el nombre del software">
                                       </div>
                                    </form>
                                 </div>
                        ...
                        <script>
                           document.getElementById('softwareCheckbox').addEventListener('change', function() {
                              const wrapper = document.getElementById('softwareInputWrapper');
                              wrapper.style.display = this.checked ? 'block' : 'none';
                           });
                        </script>
                        <!-- Agregar Bootstrap si no lo tienes -->
                        <small>Si usted cuenta con un usuario en Cypher Gestión, podría importar todos sus productos a la tienda <strong>(requiere plan Medium o superior)</strong>. Cypher Gestión es un sistema de facturación online que le permite estar al día con sus cuentas, clientes y proveedores, entre muchísimas otras funciones y reportes.</small>
                     </div>
                     {/if}
                     {else}
                     <div class="profile-acount-shalf">
               ...
               <div class="row">
                  <div class="col-12 col-md-6">
                     <div class="profile-shop-info">
                        ...
                        <a class="pagos-ir-a-pagos" href="payments/{$userinfo.usuario.id}">
                           Ir a pagos 
                           <svg width="25" height="25" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                              <path d="M19 20H5a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2Z"></path>
                              <path fill="currentColor" d="M16.5 14a.5.5 0 1 1 0-1 .5.5 0 0 1 0 1Z"></path>
                        ...
                        <div class="profile-created-shop-info">
                           ...
                           <button onclick="copiarEnlace()" style="background-color: #4CAF50; color: white; border: none; padding: 10px 20px; border-radius: 4px; cursor: pointer;">
                  ...
                  <div class="col-12 col-md-6">
                     ...
                     <div id="configuraciones">
                        ...
                        <div class="profile-conf-card">
                           ...
                           <button class="mt-2" onclick="guardarHorarios('{$userinfo.tienda.nombre_unico}', event)">
                           Guardar Horario
                           </button>
                           <br>
                        </div>
                        ...
                        <div class="profile-conf-card">
                           ...
                           <div class="" id="ubicacionInputContainer">
                              ...
                              <input type="text" id="ubicacionTienda" value="{$ubicacionTexto}" class="profile-input-ubicacion">
                           </div>
                           <br>
                           <button class="mt-2" onclick="guardarUbicacion('{$userinfo.tienda.nombre_unico}', event)">
                           Guardar ubicación
                           </button>
                        </div>
                        <script>
                     ...
                     <!--    <table class="table border-0">
                        <tr>
                            <td class="profile-shop-config-toggle-label">
                                Permitir compras sin pago inmediato
                                <small> (Esta configuracion permite que tus compradores puedan realizar un pedido sin la necesidad de pagar por esta plataforma.)</small>
                            </td>
                            <td class="text-end">
                                <div class="profile-shop-config-toggle-wrapper">
                                    <input type="checkbox" id="profile-shop-config-toggleCompras" class="profile-shop-config-toggle-input">
                                    <label for="profile-shop-config-toggleCompras" class="profile-shop-config-toggle-slider"></label>
                                </div>
                            </td>
                        </tr>
                        </table> -->
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <div class="d-flex">
               ...
               <!-- Cards de Plantillas -->
               <div class="profile-modal-info-templates d-flex">
                  <!-- Cards dispuestas horizontalmente -->
                  {foreach from=$userinfo.tipos_plantillas item=plantilla}
